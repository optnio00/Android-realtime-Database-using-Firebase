...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final int RC_TAKE_FILE = 101;
    ...
    //array of file urls
   public static ArrayList<Uri> filesurl;
    public static ArrayList<String> filesname;
    String filename;

    public static Uri mDownloadUrl = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.Show_file_list).setOnClickListener(this);
    ...
    public void beginDownload() {
        // Get path
        String path = "Log Files/" + mFileUri.getLastPathSegment();
    ...
    private void launchCamera() {
        ...
        intent.setType("text/*");
        startActivityForResult(intent, RC_TAKE_FILE);
    }
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (mDownloadUrl != null) {
            ...
            filename = "Log_Files"
                    ...
                    .getDefault())).format(new Date()) + ".txt";
            filesname.add(filename);
            // adding files url to array
            filesurl.add(mDownloadUrl);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.button_camera) {
            ...
            beginDownload();
        } else if(i == R.id.Show_file_list){
            Intent filelist = new Intent(getApplicationContext(), ShowFileActivity.class);
